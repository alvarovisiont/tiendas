...
class Ventas_Historial_Model extends CI_Model
{
   ...
   {
       $sql = "SELECT vd.ref, v.id_descuento, v.monto_descuento, v.factura, v.fecha_venta, v.monto_pagado, v.tipo_venta, v.nro_transferencia, v.id_banco, vd.* FROM ventas v 
