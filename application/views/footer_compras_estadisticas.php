...
$(function(){
    ...
    $("#buscar_grafico_mes").click(function(){
        ...
        {   
            ...
            $.getJSON('Compras_estadisticas/traer_graficos_mes',{año: año},function(data)
            {   
                    var x = 0;
                    var relleno = [];
                    var monto;
                        while(x < data.length)
                        {
                            relleno.push({"category" : mes[data[x].mes -1], "total" : data[x].monto});
                            x = x + 1;
                        }
                    console.log(relleno);
    ...
    $("#buscar_grafico_dia").click(function(){
        ...
        else
        {
            ...
            $.getJSON('Compras_estadisticas/traer_graficos_dias',{año: año, mes: mes},function(data)
            {
                var chart4;
                var graph4;
                var monto;
                ...
                var x = 0;
                    ...
                    while(x < data.length)
                    {
                        relleno.push({"category" : data[x].dia, "total" : data[x].monto});
                        x = x + 1;
                    }
