				...
				<?php 
					if(!empty($data))
					{
						...
						foreach ($data as $row) 
						{
							...
							echo '<tr>
									<td>Sub-total</td>
									<td colspan="6" align="right" style="padding-right: 8%"><strong>'.number_format($sub_total,2,",",".")." ".$this->session->userdata('siglas').'</strong></td>
								</tr>
								<tr>
									<td>Iva</td>
									<td colspan="6" align="right" style="padding-right: 8%"><strong>'.number_format($iva,2,",",".")." ".$this->session->userdata('siglas').'</strong></td>
								</tr>
								<tr>
									<td>Total</td>
									<td colspan="6" align="right" style="padding-right: 8%"><strong>'.number_format($total,2,",",".")." ".$this->session->userdata('siglas').'</strong></td>
								</tr>';
					}
				?>	
			</tbody>
