...
<header>
	...
	<?php
		...
		{
		?>
			<img src="./img/<?php echo $this->session->userdata('logo'); ?>" alt="" width="200px" height="100px" style='float: left; display:inline-block'>
		<?php
		}
	?>
	</div>
		...
		<table width="100%" cellpadding="" border="1" cellspacing="">
  			...
  			<tr>
				...
				<tr>
					...
					<th style="text-align: center;">Fecha_Agregado</th>
				</tr>
			</thead>
